...
#ifndef __HARMONICANGLEFORCECOMPUTETEST_H__
#define __HARMONICANGLEFORCECOMPUTETEST_H__
...
/*! Harmonic angle forces are computed on every particle in the simulation.
    ...
    \ingroup computes
*/
class HarmonicAngleForceComputeTEST : public ForceCompute
    {
    public:
        //! Constructs the compute
        HarmonicAngleForceComputeTEST(std::shared_ptr<SystemDefinition> sysdef);

        //! Destructor
        virtual ~HarmonicAngleForceComputeTEST();
...
void export_HarmonicAngleForceComputeTEST(pybind11::module& m);
