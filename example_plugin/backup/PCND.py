...
class PCNDsingle(force._force):
    ...
    def __init__(self):
        ...
        if not hoomd.context.exec_conf.isCUDAEnabled():
            self.cpp_force = _PCND.PCNDHarmonicAngleForceCompute(hoomd.context.current.system_definition);
        else:
            self.cpp_force = _PCND.PCNDHarmonicAngleForceComputeGPU(hoomd.context.current.system_definition);
