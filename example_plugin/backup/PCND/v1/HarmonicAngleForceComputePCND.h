...
/*! \file HarmonicAngleForceComputePCND.h
...
#ifndef __HARMONICANGLEFORCECOMPUTEPCND_H__
#define __HARMONICANGLEFORCECOMPUTEPCND_H__
...
class HarmonicAngleForceComputePCND : public ForceCompute
    {
    public:
        //! Constructs the compute
        HarmonicAngleForceComputePCND(std::shared_ptr<SystemDefinition> sysdef);

        //! Destructor
        virtual ~HarmonicAngleForceComputePCND();
...
void export_HarmonicAngleForceComputePCND(pybind11::module& m);
